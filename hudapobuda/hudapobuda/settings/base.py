"""
Django settings for hudapobuda project.
...
WSGI_APPLICATION = 'hudapobuda.wsgi.application'
...
if os.getenv('DJANGO_ENABLE_S3', False):
    ...
    AWS_LOCATION = os.getenv('DJANGO_AWS_LOCATION', 'hudapobuda')
